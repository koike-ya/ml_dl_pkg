...
class LogMel:
    def __init__(self, sample_rate, window_size, hop_size, mel_bins, fmin, fmax, device):
        ...
        self.bn0 = nn.BatchNorm2d(mel_bins).to(device)
    ...
    def __call__(self, signals):
        ...
        for idx_channel in range(signals.size(0)):
            x = signals[idx_channel, :]   # (1, 1, data_length)
